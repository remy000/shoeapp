  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <h1 className="mt-10 font-palanquin text-[70px] max-sm:text-[55px] max-sm:leading-[70px] font-bold">
          <span className="xl:bg-white xl:whitespace-nowrap  z-10 pr-2">
            New Arrival
          </span>
          <br />
        ...
        <div className="flex justify-start items-start flex-wrap w-full mt-20 gap-16">
          {statistics.map((stat) => (
            <div key={stat.label}>
              <p className="text-4xl font-palanquin font-bold text-coral-red">
                {stat.value}
              </p>
      ...
      >
        <img
          ...
          width={610}
          height={600}
          className="object-contain relative z-10 pl-7"
        />
